...
<title>Contacto</title> <!-- Aquí va el título de la página -->
...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("v.carlosjose@gmail.com"); // Dirección a la que llegaran los mensajes.

// Aquí van los datos que apareceran en el correo que reciba

    $mail->WordWrap = 50; 
    $mail->IsHTML(true);     
    $mail->Subject  =  "Cliente Web"; // Asunto del mensaje.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "v.carlosjose@gmail.com";  // Correo Electrónico
    $mail->Password = ".13556178."; // Contraseña del correo
